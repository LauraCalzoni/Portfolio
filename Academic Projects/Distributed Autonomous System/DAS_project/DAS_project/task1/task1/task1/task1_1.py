...
if len(sys.argv) != 5 and (len(sys.argv) != 2 or sys.argv[1] != "default"):
	print("Bad usage, launch the script with one of the following line:")
	print("python3 task1_1.py <MAX_ITERS> <NN> <d> <graph_type>")
	print("or")
	print("python3 task1_1.py default")
	exit()
...
# Compute Optimal Solution (Offline)
...
# Terminal iteration, for counting the last loss function
for ii in range(NN):
...
# consensus error
# sum over all the agents of the norm of the difference between my estimate and the average, 
